...
from transformers import BartForConditionalGeneration, BartTokenizer, MT5ForConditionalGeneration, MT5Tokenizer, \
...
def machine_learning(text, min_len, max_len):
    ...
    inputs = tokenizer.encode(text, return_tensors="pt", max_len=1080, truncation=True, padding=True)
    summary_ids = model.generate(inputs, max_length=max_len, min_length=min_len, length_penalty=2.0,
